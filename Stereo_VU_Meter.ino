/*
**********************************************************************
* Stereo VU Meter for 1 or 2 LED rings or strips build by Tanusnet Malikipuram
...
**********************************************************************
* Last updated 20180202 by Meesatyam
*
* This code is free for personal use, not for commercial purposes.
* Please leave this header intact.
*
* contact: tanusnet@gmail.com
**********************************************************************
*/
#include <Adafruit_NeoPixel.h>
#define nonLinearLogAudio 

//#define led_strip_20                                      //uncomment this if you are using a single 60 LED strip
#define led_2_strip_20                                  //uncomment this if you are using two 60 LED strips
...
#if defined (led_strip_20)
  //settings for a 60 led strip

  int stripNumOfLeds = 20;                                  // the total number of leds
...
#elif defined (led_2_strip_20)
  //settings for 2 60 led strips

  int stripNumOfLeds = 20;
